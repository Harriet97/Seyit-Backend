...
p1 = Property.create(name: "Cozy One-Bedroom flat in St. John`s Wood", host: h1, postcode: "NW8", location: "Abercorn Place", long: -0.181080, lat: 51.532320, price: 1750, sleeps: 3, bedrooms: 1, bathrooms: 1, balcony: false, washing_machine: true, kettle: true, coffee_machine: true, fridge: true, microwave: true, kitchenware: true, elevator: true, living_room: true, shower: true, bathtub: false, hairdryer: true, iron: true, hoover: true, mop: true, bedding: true, tv: true, wifi: true)
p2 = Property.create(name: "Comfortable Three-bedroom flat in Arsenal", host: h1, postcode: "N5", location: "Tywford House", long:  -0.0792, lat: 51.5782,price: 2250, sleeps: 6, bedrooms: 3, bathrooms: 1, balcony: true, washing_machine: true, kettle: true, coffee_machine: true, fridge: true, microwave: true, kitchenware: true, elevator: true, living_room: true, shower: false, bathtub: true, hairdryer: true, iron: true, hoover: true, mop: true, bedding: true, tv: false, wifi: true)
p3 = Property.create(name: "Spacious Four-bedroom house in Hoxton", host: h1, postcode: "E2", location: "Hackney Road", long: -0.062350, lat: 51.514439,price: 4000, sleeps: 8, bedrooms: 4, bathrooms: 2, balcony: false, washing_machine: true, kettle: true, coffee_machine: true, fridge: true, microwave: true, kitchenware: true, elevator: false, living_room: true, shower: true, bathtub: false, hairdryer: true, iron: true, hoover: true, mop: true, bedding: true, tv: false, wifi: true)
p4 = Property.create(name: "Bright One-bedroom flat in Holloway Road", host: h1, postcode: "N7", location: "Buckmaster House", long: -0.118040, lat: 51.556940, price: 1750, sleeps: 3, bedrooms: 1, bathrooms: 1, balcony: true, washing_machine: true, kettle: true, coffee_machine: true, fridge: true, microwave: true, kitchenware: true, elevator: true, living_room: true, shower: false, bathtub: true, hairdryer: true, iron: true, hoover: true, mop: true, bedding: true, tv: true, wifi: true)
p5 = Property.create(name: "British-Style One-bedroom flat in Shepherd’s Bush", host: h1, postcode: "W12", location: "Sterne Street", long: -0.220400, lat: 51.505350,price: 1950, sleeps: 3, bedrooms: 1, bathrooms: 1, balcony: false, washing_machine: true, kettle: true, coffee_machine: true, fridge: true, microwave: true, kitchenware: true, elevator: false, living_room: false, shower: false, bathtub: true, hairdryer: true, iron: true, hoover: true, mop: true, bedding: true, tv: true, wifi: true)
p6 = Property.create(name: "Modern Duplex Four-bedroom flat in Dalston", host: h1, postcode: "NW16", location: "Stoke Newington Road", long: -0.0748, lat: 51.5517,price: 2750, sleeps: 6, bedrooms: 4, bathrooms: 1, balcony: false, washing_machine: true, kettle: true, coffee_machine: true, fridge: true, microwave: true, kitchenware: true, elevator: false, living_room: false, shower: true, bathtub: false, hairdryer: true, iron: true, hoover: true, mop: true, bedding: true, tv: false, wifi: true)
p7 = Property.create(name: "Luxurious Two-bedroom Flat in Aldgate", host: h1, postcode: "E1", location: "Hessel Street", long: -0.062350, lat: 51.514440,price: 2550, sleeps: 5, bedrooms:2, bathrooms: 1, balcony: true, washing_machine: true, kettle: true, coffee_machine: true, fridge: true, microwave: true, kitchenware: true, elevator: false, living_room: true, shower: false, bathtub: true, hairdryer: true, iron: true, hoover: true, mop: true, bedding: true, tv: true, wifi: true)
